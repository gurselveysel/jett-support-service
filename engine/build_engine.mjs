...
// jett_engine_v9_source.html, producing jett_engine_v9_template.html with
...
let html = readFileSync('jett_engine_v9_source.html', 'utf8');
...
writeFileSync('jett_engine_v9_template.html', html, 'utf8');
console.log('OK — jett_engine_v9_template.html,', (html.length / 1024).toFixed(0) + 'KB');
